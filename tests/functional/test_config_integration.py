...
class TestConfigIntegration:
    ...
    def test_config_file_structure(self):
        ...
        required_keys = ['name', 'description', 'assets', 'risk_budget', 
                        'volatility_targeting', 'rebalancing', 'risk_controls']
        ...
        assert abs(total_budget - 1.0) < 0.01, f"Risk budget sums to {total_budget}, should be 1.0"
    ...
    def test_config_parameter_types(self):
        ...
        assert isinstance(config['risk_controls']['max_single_asset_weight'], (int, float))
