...
class TestEquityVolBarbellIntegration:
    ...
    def test_portfolio_manager_integration(self, strategy):
        ...
        portfolio_manager.current_weights['TQQQ'] += 0.11  # 11% drift exceeds 10% threshold
    ...
    def test_risk_management_integration(self, strategy):
        ...
        class MockRiskManager:
            ...
            def check_risk_limits(self, weights, market_data):
                ...
                current_drawdown = abs(market_data['Drawdown'].min()) if 'Drawdown' in market_data else 0
    ...
    def test_backtesting_integration(self, strategy):
        ...
        market_data = pd.DataFrame({
            ...
            'VIX_MA20': pd.Series(20 + np.random.normal(0, 3, 30)).rolling(window=10, min_periods=1).mean(),
        ...
        class MockDataPipeline:
            ...
            def preprocess_data(self, raw_data):
                ...
                for col in processed.columns:
                    if not col.endswith('_Returns'):
                        ...
                        if returns_col not in processed.columns:
                            processed[returns_col] = processed[col].pct_change().fillna(0)
                ...
                if 'VIX_MA20' not in processed.columns:
                    processed['VIX_MA20'] = processed['VIX'].rolling(window=20, min_periods=1).mean()
