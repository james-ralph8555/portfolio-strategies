...
from tests.fixtures.sample_data import create_sample_price_data, create_sample_config, create_invalid_config
...
class TestEquityCrisisAlphaStrategy:
    ...
    def test_apply_black_litterman_tilt(self):
        ...
        tilted_weights = self.strategy._apply_black_litterman_tilt(base_weights, self.sample_data)
    ...
    def test_apply_black_litterman_tilt_no_views(self):
        ...
        tilted_weights = strategy._apply_black_litterman_tilt(base_weights, self.sample_data)
    ...
    def test_apply_volatility_targeting(self):
        ...
        targeted_weights = self.strategy._apply_volatility_targeting(base_weights, self.sample_data)
    ...
    def test_apply_volatility_targeting_high_leverage(self):
        ...
        targeted_weights = strategy._apply_volatility_targeting(base_weights, self.sample_data)
