...
class TestEquityVolBarbellStrategy:
    ...
    def sample_market_data(self):
        ...
        data["VOO_Returns"] = np.random.normal(
            0.0005, 0.015, 100
        )  # Moderate volatility
        ...
        data["VIX"] = (
            20
            + 10 * np.sin(np.linspace(0, 4 * np.pi, 100))
    ...
    def test_calculate_drawdown_trigger_normal_market(
    ...
    def test_calculate_drawdown_trigger_drawdown_scenario(
        self, strategy, sample_market_data
    ):
    ...
    def test_calculate_drawdown_trigger_volatility_spike(
        self, strategy, sample_market_data
    ):
    ...
    def test_size_vol_sleeves_stress_vix(self, strategy, sample_market_data):
        ...
        vix_values = [15] * 252 + [40] * (
            len(stress_vix_data) - 252
        )  # Low base, then high stress
